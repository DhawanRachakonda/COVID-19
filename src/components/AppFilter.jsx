            ...
            <Form inline>
                <Row>
                    <Form.Group controlId="exampleForm.SelectCustom">
                        ...
                        <Col>
                            <Form.Control as="select" custom onChange={setSelectedUser}>
                                <option value="0" selected={selectedUser === "1"}>Select User</option>
                                <option value="1" selected={selectedUser === "1"}>User 1</option>
                                <option value="2" selected={selectedUser === "2"}>User 2</option>
                                <option value="3" selected={selectedUser === "3"}>User 3</option>
                            </Form.Control>
                        </Col>
                    </Form.Group>
                    ...
                    <Form.Group>
                        ...
                        <Button type="reset" onClick={reset} className="margin-left--2">Reset</Button>
                    </Form.Group>
                </Row>
            </Form>
        </Navbar>
